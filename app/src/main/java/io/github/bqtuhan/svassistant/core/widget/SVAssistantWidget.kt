        ...
        GlanceTheme {
            Column(
                modifier = GlanceModifier
                    .fillMaxSize()
                    .background(ColorProvider(day = Color(0xFFF5E6D3), night = Color(0xFFF5E6D3))) // Parchment Cream
                    .padding(16.dp),
                ...
                Text(
                    ...
                    style = TextStyle(
                        color = ColorProvider(day = Color(0xFF5D4037), night = Color(0xFF5D4037)), // Dark Earth
                ...
                Text(
                    ...
                    style = TextStyle(
                        color = ColorProvider(day = Color(0xFF8D6E63), night = Color(0xFF8D6E63)), // Wood Brown
                        fontSize = 16.sp
                    )
                )
                Spacer(modifier = GlanceModifier.height(8.dp))
                Text(
                    ...
                    style = TextStyle(
                        color = ColorProvider(day = Color(0xFFFFD700), night = Color(0xFFFFD700)), // Stardew Gold
                        fontWeight = FontWeight.Bold, 
                        fontSize = 18.sp
                    )
                )
